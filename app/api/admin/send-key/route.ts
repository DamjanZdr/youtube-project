      ...
      await resend.emails.send({
        ...
        html: `
          ...
          <html>
            ...
            <body style="margin: 0; padding: 0; background-color: rgba(255,255,255,0.01); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: rgba(255,255,255,0.01);">
                <tr>
