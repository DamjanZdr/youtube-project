-- =============================================================================
-- HELP CENTER CONTENT: Categories Reorganization + Initial Articles
-- Run this in your Supabase SQL Editor
-- =============================================================================

-- First, update category positions and descriptions for better organization
...
-- Delete old categories we're replacing
DELETE FROM help_categories WHERE slug IN ('projects', 'packaging', 'channel', 'team', 'billing', 'youtube', 'feature-requests');

-- Insert reorganized categories (matching app pages/features)
INSERT INTO help_categories (name, slug, description, icon, position) VALUES
  ('Hub & Studios', 'hub-studios', 'Creating and managing your studios', 'building-2', 2),
  ('Projects', 'projects', 'Creating and organizing video projects', 'folder-kanban', 3),
  ('Board & Tasks', 'board-tasks', 'Using the kanban board and task management', 'layout', 4),
  ('Wiki & Documentation', 'wiki', 'Creating documentation and guides for your team', 'book-open', 5),
  ('Channel & Branding', 'channel-branding', 'Channel preview and branding design', 'tv', 6),
  ('Packaging & Thumbnails', 'packaging', 'Designing thumbnails and video packaging', 'image', 7),
  ('Team & Collaboration', 'team', 'Inviting members and managing permissions', 'users', 8),
  ('Billing & Subscriptions', 'billing', 'Plans, payments, and account management', 'credit-card', 9);
...
Blueprint is your all-in-one production hub for YouTube content creation. Whether you''re a solo creator or managing a team, Blueprint helps you plan, organize, and produce better videos.

## What Can You Do With Blueprint?

### 📁 Organize Your Projects
Create projects for each video idea. Track them from initial concept through to publication with our visual kanban board.

### 🎨 Design Your Packaging
Create stunning thumbnails and titles before you even start filming. Preview how they''ll look on YouTube.

### 📺 Preview Your Channel
See exactly how your channel page will look with new videos, banners, and branding—before going live.

### 📋 Manage Tasks
Break down video production into tasks. Assign them to team members. Never miss a deadline.

### 📖 Document Everything
Build a wiki for your team with scripts, guidelines, and resources all in one place.

### 👥 Collaborate With Your Team
Invite editors, designers, and collaborators. Set permissions so everyone sees what they need.
...
After signing in, you''ll land on the **Hub** - your home base showing all your studios.
...
- **Studio Slug**: This creates your unique URL (e.g., `myblueprint.studio/studio/your-slug`)

## Step 4: Start Creating!

Once your studio is created, you''ll be taken to the studio home page where you can:
...
Once you''re inside a studio, you''ll see the main navigation on the left sidebar. Here''s what each section does:
...
## 📋 Board
A kanban-style board showing all projects across different stages: Idea → Script → Recording → Editing → Scheduled → Published.

## 📖 Wiki
Your team''s documentation hub. Create folders and documents for scripts, guidelines, and resources.

## ⚙️ Settings
Manage studio settings, members, integrations, and danger zone options like deleting the studio.
...
- Press `?` to see all keyboard shortcuts (coming soon)
- Quick search with `Cmd/Ctrl + K` (coming soon)',
  false,
  true
);
...
Need to hand off your studio to someone else? Here''s how to transfer ownership.
...
- **🎬 Recording** - Filming/recording content
- **✂️ Editing** - Post-production work
...
- **Scripts & Outlines**: Store video scripts alongside projects
...
- **Channel Name & Handle**: Your display name and @handle
...
To connect your YouTube channel and sync data, go to **Settings > YouTube Integration**.',
  true,
  true
),
(
...
## Title + Thumbnail Combo

Your title and thumbnail should work together:
- Don''t repeat the same text in both
...
| **Admin** | All member permissions + manage members |
...
4. You''ll be added to the studio automatically
...
Go to **Account Settings > Subscription** to upgrade, downgrade, or manage your plan.',
  true,
  true
),
(
...
Go to **Account Settings** (click your profile > Account Settings) to see:
- Current plan
- Billing cycle
- Next payment date
- Usage statistics
...
**Note**: If you''re over the new plan''s limits, you''ll need to reduce studios/projects/members first.
...
Download invoices from **Account Settings > Billing History**.',
  false,
  true
),
(
...
Got a license key? Here''s how to redeem it.
...
If you''re already subscribed and redeem a key:
...
Still having trouble? [Contact Support](/help/tickets/new) with your key and we''ll help!',
  false,
  true
);

-- =============================================================================
-- ARTICLES: General Discussion (seed with one welcome post)
-- =============================================================================
...
This is the place to chat about anything Blueprint-related that doesn''t fit in other categories.
...
-- =============================================================================
-- Done! All categories reorganized and articles created.
-- =============================================================================
